...
public class HomeCheapGoodsAdapter extends MyBaseAdapter<HomeCheapGoodsBean> {

	public HomeCheapGoodsAdapter(Context context) {
		super(context);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		HomeCheapGoodsBean bean = getItem(position);
